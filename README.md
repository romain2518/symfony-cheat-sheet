...
| PHPUnit | `composer require --dev symfony/test-pack`<br>`php bin/console make:test`<br>Start tests with `bin/phpunit` | [Doc assertions](https://symfony.com/doc/current/testing.html#testing-the-response-assertions) |
